...
| 工作流程类型 | 代码 | 部门顺序 |
|-------------|------|---------|
| 硬件产品开发 | `hardware_product` | 产品部 → 项目部 → 硬件部 → 结构部 → 软件部 → 测试部 |
| 纯软件开发 | `software_only` | 产品部 → 项目部 → 软件部 → 测试部 |
| 硬件开发 | `hardware_only` | 产品部 → 项目部 → 硬件部 → 结构部 → 测试部 |
| 结构设计 | `structure_only` | 产品部 → 项目部 → 结构部 → 测试部 |
...
```json
{
  "hardware_product": {
    ...
    "subfolders": {
      ...
      "硬件部": ["原理图", "PCB 设计", "BOM 表", "EVT 报告", "DVT 报告", "PVT 报告", "问题跟踪"],
      "结构部": ["ID 设计", "结构设计", "模具开发", "手板管理", "包装设计"],
      "软件部": ["需求分析", "设计文档", "API 文档", "版本发布", "代码评审", "固件发布"],
      "测试部": ["测试计划", "测试用例", "EVT 测试", "DVT 测试", "PVT 测试", "认证测试", "问题跟踪"]
    }
  },
  "software_only": {
    "name": "纯软件开发",
...
| 设计文档 | 软件部 | 硬件部 |
| 原理图 | 硬件部 | 软件部、结构部 |
| EVT/DVT/PVT 报告 | 硬件部 | 测试部、项目部 |
| ID 设计 | 结构部 | 产品部、硬件部 |
| 结构设计 | 结构部 | 硬件部 |
| 测试计划 | 测试部 | 硬件部、软件部、结构部 |
| 测试用例 | 测试部 | 硬件部、软件部、结构部 |
| 测试报告 | 测试部 | 硬件部、软件部、结构部 |
